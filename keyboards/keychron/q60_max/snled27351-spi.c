...
#ifdef SNLED27351_SPI_CS_PIN
static pin_t cs_pins[] = {SNLED27351_SPI_CS_PIN};
#elif defined(DRIVER_CS_PINS)
static pin_t cs_pins[] = DRIVER_CS_PINS;
#else
#    error "No CS pins defined for SNLED27351 SPI driver"
#endif
...
void snled27351_init_drivers(void) {
    ...
    gpio_set_pin_output(LED_DRIVER_SHUTDOWN_PIN);
    gpio_write_pin_high(LED_DRIVER_SHUTDOWN_PIN);
#endif
...
void snled27351_set_led_control_register(uint8_t index, bool red, bool green, bool blue) {
    ...
    (void)control_register_r;
    (void)control_register_g;
    (void)control_register_b;
...
#    if defined(LED_DRIVER_SHUTDOWN_PIN)
    gpio_write_pin_low(LED_DRIVER_SHUTDOWN_PIN);
#    else
    for (uint8_t i = 0; i < SNLED27351_DRIVER_COUNT; i++)
