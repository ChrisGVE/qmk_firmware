...
/* matrix_idle and first_key_scan are unused but kept for potential future use */
...
uint8_t matrix_scan(void) {
    /* NOTE: Do NOT call matrix_scan_quantum() here.
     * In modern QMK, the core calls it automatically after matrix_scan().
     * Calling it here would cause infinite recursion.
     */
